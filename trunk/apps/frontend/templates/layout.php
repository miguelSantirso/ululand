...
<div id="userMenu">
	<ul class="horizontalListMenu small">
		<?php if( $authenticated ): ?>
			...
			<li id="logoutLink"><?php echo link_to(__('Logout'), 'home/Logout'); ?></li>
		...
		<?php endif; ?>
		<?php if( !$authenticated ): ?>
			<li id="loginLink"><?php echo link_to(__('Login'), 'home/Login'); ?></li>
			<li id="registerLink"><?php echo link_to(__('Register'), 'home/Register'); ?></li>
