	...
	<div class="fixedWidth half alignCenter">
		<?php echo form_tag('@sf_guard_signin') ?>
		    ...
		    <div class="form-field fixedWidth third contentBox light alignCenter" id="sf_guard_auth_username">
		      ...
		      form_error('username'),
		      "<p class='noSpace alignCenter'>".input_tag('username', $sf_data->get('sf_params')->get('username'))."</p>";
		      ?>
		    </div>
		    <div class="form-field fixedWidth third contentBox light alignCenter" id="sf_guard_auth_password">
		      ...
		      echo  
		        "<p class='noSpace alignCenter'>".label_for('password', __('Password'))."</p>",
		      	form_error('password'),
		        "<p class='noSpace alignCenter'>".input_password_tag('password')."</p>";
		      ?>
		    </div>
		    <div class="form-field fixedWidth third contentBox light alignCenter" id="sf_guard_auth_remember">
		      <?php
		      echo "<p class='noSpace alignCenter'>".label_for('remember', __('Remember me?')." "),
		      checkbox_tag('remember')."</p>";
		      ?>
		    </div>
		      <?php 
			  echo "<p class='alignCenter contentBox'>".submit_tag(__('sign in')) ."</p>"
			  ?>
		    <div style="clear:both;"></div>
		  	<p class="alignCenter"><?php echo link_to(__('Forgot your password?'), '@sf_guard_password', array('id' => 'sf_guard_auth_forgot_password')) ?></p>
		</form>
	</div>
</div>