package com.pncil.General 
{
	...
	import flash.events.*;
	/**
	* Clase que simplifica las operaciones de entrada/salida.
	* Para crear esta clase me he inspirado en la clase "Input" que viene en los tests de Box2D Flash, creada por Matthew Bush
	...
	*/	
	public class Input{
		...
		public function Input(stageMc:Sprite){
			...
			stageMc.stage.addEventListener(MouseEvent.CLICK, mouseRelease);
			stageMc.stage.addEventListener(MouseEvent.MOUSE_MOVE, mouseMove);
			stageMc.stage.addEventListener(Event.MOUSE_LEAVE, mouseLeave);
