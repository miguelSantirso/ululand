...
$t->diag('Receta de código: Uso de Addchild(tags: actionscript, addchild, as3, bitmap)');

$t->isa_ok($codePiece->getTagsString(), 'string', 'Uso_de_AddChild->getTagsString() retorna un string.');

$t->is($codePiece->getTagsString(), "actionscript, addchild, as3, bitmap", 'Uso_de_AddChild->getTagsString() retorna los tags de la receta de código');
